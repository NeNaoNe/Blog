...
Route::group(['middleware' => 'auth'], function(){
    // All the routes here can only be accessed if you log in
    ...
    Route::group(['prefix' => 'post', 'as' => 'post.'], function(){
        ...
        // create - open the ceate page <a>
        // store - save to db <form>

        // edit - open the edit page <a>
        // update - save to db <form>
    });
